...
public class SortAndSearch {
   ...
   * <p>
   * The use of a enhanced for loop returns the items in ascending order
	 *     but is to use with care since it destroyes the tree structure
   *
   */
  public static class BinaryTree<T> implements Iterable<T> {
    ...
    private static class Node<T> implements Iterable<T> {
       ...
       *     traverse the tree defined by Nodes
   ...
   *     discouraged if you intend to loop through the list please use
	 *     the enhanced for loop and
	 *     if you want to acces individual fields use an array or alike
   *
   */
  public static class LinkedList<T> implements Iterable<T> {
    ...
    private class Node<T> {
       ...
       * <p>
       * This keeps the first Node always up to date
